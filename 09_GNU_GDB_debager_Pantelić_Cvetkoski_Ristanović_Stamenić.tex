...
specifičnostima GNU GDB debagera, načinom upravljanja i njegovim korišćenjem u razvojnim okruže\-njima. 
...
zavisi i od programskog jezika koji se koristi, kao i dostupnih alata poput debagera. 
...
ili debagovanje jezgra operativnog sistema.
...
mogu reći u kom trenutku tokom izvršavanja programa vrednost
...
GDB pruža mogućnost udaljenog debagovanja. Jedan način uspostavljanja komunikacije za debagovanje udaljenog uređaja je kreiranje udaljenog posrednika (podrške) koji je specifičan za konkretnu arhitekturu računara koji se debaguje. Udaljeni posrednik je programski kod koji se izvršava na udaljenom uređaju i omogućava komunikaciju sa GDB-om. Specifičnost ovog načina komunikacije je neophodnost pravljenja udaljenog posrednika pri svakom debagovanju. \\
