...
na sledeću mašinsku instrukciju sa ili bez poziva funkcije. Za one koji su navikli da rade iz konzole (slika \ref{fig:gdbgui}.5), 
tu se nalazi i terminal (slika \ref{fig:gdbgui}.6). Na slici \ref{fig:gdbgui} je prikazan sam izgled programa.
