...
\item Padovi sistema (programa) ili oštećenja podataka\cite{deb_app}
\end{enumerate}
...
\item Nedostatak posvećenosti kvalitetu \cite{deb_app}
\end{enumerate}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[scale=0.3]{breakpoints_res.png}
\end{center}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[scale=0.3]{signals.png}
\end{center}
